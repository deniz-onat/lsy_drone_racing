...
from lsy_drone_racing.control.legacy.kafa1500_v2.utils import clip_norm, slew_angle

if TYPE_CHECKING:
    from numpy.typing import NDArray

    from lsy_drone_racing.control.legacy.kafa1500_v2.config import FeedbackConfig
    from lsy_drone_racing.control.legacy.kafa1500_v2.types import Observation, Reference, Vec3
