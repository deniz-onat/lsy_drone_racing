...
from lsy_drone_racing.control.legacy.kafa1500_v2.types import Reference

if TYPE_CHECKING:
    from lsy_drone_racing.control.legacy.kafa1500_v2.config import ReferenceConfig
    from lsy_drone_racing.control.legacy.kafa1500_v2.types import CubicPath, Vec3
