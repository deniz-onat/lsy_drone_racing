...
from lsy_drone_racing.control.legacy.kafa1500_attitude.attitude_feedback import AttitudeFeedback
from lsy_drone_racing.control.legacy.kafa1500_attitude.config import (
    FeedbackConfig,
    PathConfig,
    ReferenceConfig,
)
from lsy_drone_racing.control.legacy.kafa1500_attitude.gate_targets import GateTargetPlanner
from lsy_drone_racing.control.legacy.kafa1500_attitude.reference_manager import ReferenceManager
from lsy_drone_racing.control.legacy.kafa1500_attitude.spline_path import CubicPathBuilder
from lsy_drone_racing.control.legacy.kafa1500_attitude.types import FlightPhase, Reference

if TYPE_CHECKING:
    from crazyflow import Sim
    from numpy.typing import NDArray

    from lsy_drone_racing.control.legacy.kafa1500_attitude.types import Observation
