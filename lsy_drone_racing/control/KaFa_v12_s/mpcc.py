"""Tunnel-constrained time-optimal MPCC core for KaFa_1500_v12_s (acados SQP-RTI).
...
Own codegen namespace ``kafa_v12_s`` (different dimensions than v10.x -- never share; see the
...
def _build_v11_solver(s: MPCCSettings, a_max: float) -> AcadosOcpSolver:
    """Code-generate the v10.1 OCP plus the soft tunnel constraints (kafa_v12_s namespace)."""
