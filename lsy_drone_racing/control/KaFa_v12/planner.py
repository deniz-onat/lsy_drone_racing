"""Reference planning for KaFa_1500_v12: guarded-smoothed, parity-capped global spline.
...
from lsy_drone_racing.control.KaFa_v12.avoidance import (
    nudge_lateral,
    push_off_obstacles,
    reversal_turn,
)
from lsy_drone_racing.control.KaFa_v12.speed_profile import SpeedProfile

if TYPE_CHECKING:
    from numpy.typing import NDArray

    from lsy_drone_racing.control.KaFa_v12.observation import DroneObservation
    from lsy_drone_racing.control.KaFa_v12.settings import PlannerSettings, SmoothPlannerSettings
