...
if TYPE_CHECKING:
    ...
    from lsy_drone_racing.control.KaFa_v12.arc_path import TunnelArcPath
    from lsy_drone_racing.control.KaFa_v12.settings import MPCCSettings
...
def _build_v11_solver(s: MPCCSettings, a_max: float) -> AcadosOcpSolver:
    ...
    return AcadosOcpSolver(ocp, json_file="c_generated_code/kafa_v12.json", verbose=False)
