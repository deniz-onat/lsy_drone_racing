"""Consolidated takeoff-phase chain for the KaFa_v12_1 controller.
...
from lsy_drone_racing.control.KaFa_v12_1.attitude import attitude_action
...
if TYPE_CHECKING:
    ...
    from lsy_drone_racing.control.KaFa_v12_1.settings import (
        ControllerSettings,
